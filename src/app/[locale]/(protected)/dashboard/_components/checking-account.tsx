...
import { createCheckingAccount } from "@/lib/actions/account";
import { catchError, cn } from "@/lib/utils";
import { type Create as CreateType } from "@/types/dash";

const CheckingAccountDrawerDialog = ({
  create,
}: {
...
const Create = ({ create, className, ...props }: Props) => {
  ...
  function handleSubmit() {
    startTransition(async () => {
      try {
        const res = await createCheckingAccount();
        if (res === true) {
...
CheckingAccountDrawerDialog.displayName = "CheckingAccountDrawerDialog";
Create.displayName = "Create";

export { CheckingAccountDrawerDialog, Create };
